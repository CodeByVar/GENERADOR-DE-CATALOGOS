...
def generar_html_y_imagenes(db, codigos, imagenes_por_fila, layout="desktop", output_filename="catalogos.html", forzar_imagenes=False, db_norm=None, db_clean=None, whatsapp_phone=None):
    ...
    grid_cols_css = "grid-template-columns: repeat(5, minmax(0, 1fr));" if layout != "mobile" else "grid-template-columns: repeat(4, minmax(0, 1fr));"
...
<head>
  ...
  <style>
    ...
    /* ──── OPTIMIZACIÓN RESPONSIVA MÓVIL Y TABLET (4 COLUMNAS) ──── */
